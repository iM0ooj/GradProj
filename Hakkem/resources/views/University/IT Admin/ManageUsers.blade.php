    ...
    <aside class="sidebar">
        <ul>
            <li class="sidebar-item ">
                <a href="../../../views/University/IT Admin/MyProfile.html">
                    <img src="../../../../public/images/image-profile-icon.png" alt="Profile">
                    My Profile
                </a>
            </li>
            <li class="sidebar-item active">
                <a href="../../../views/University/IT Admin/ManageUsers.html">
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            <a href="Permission.html" class="action-btn">Grant Permission</a>

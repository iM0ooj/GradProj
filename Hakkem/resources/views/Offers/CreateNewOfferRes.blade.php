...
<head>
    ...
    <title>CreateNewOfferRes</title>
        <link rel="stylesheet" href="{{ asset(path:'hakkem/css/Offers/CreateNewOfferRes.css') }}" />
</head>
<body>
   <!-- HEADER -->
   <div class="center">
  ...
  <div class="double-field">
    <div class="form-group half">
      ...
      <input type="text" id="duration" placeholder="e.g. 2 Weeks" />
    </div>
    <div class="form-group half">
      <label>Price:</label>
      <input type="number" id="price" placeholder="SAR" />
    </div>
  </div>
...
<script>
    ...
    function setPrice() {
      document.getElementById("price").value = "150 SAR";
    }
  </script>
</body>
</html>
